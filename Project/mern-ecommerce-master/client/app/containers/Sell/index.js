  ...
  render() {
    ...
    return (
      <div className='sell'>
        ...
        <h2>Become A Happly Khajana Store Seller!</h2>
        <hr />
        <Row>
            ...
            <Row>
              <Col xs='12' className='order-2 order-md-1 text-md-center mb-3'>
                <div className='agreement-banner-text'>
                  <h3>Would you like to sell your products on Happly Khajana Store!</h3>
                  <h5>Grow your business with Happly Khajana Store</h5>
                  <b>Apply Today</b>
                </div>
              </Col>
